...
See the Workflow1.5 folder for the latest updates: counting the number of individuals and extracting frames from video files. A full 2.0 version of the whole pipeline coming soon, running YOLOv11 and MegaDetector v6...
